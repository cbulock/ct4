...
excerpt: >-
  ...
  Just for some background, my <a
  href="http://www.cbulock.com/2004/10/improved_site_search.html"
  title="Improved Site Search">original Livesearch</a> was based on <a
  href="http://blog.bitflux.ch/wiki/LiveSearch" title="LiveSearch">some
  Javascript</a> and a<a
  href="http://depository.unfoldedorigami.com/php/bettersearch.phpx"
  title="Slightly Better Search for Movabletype"> PHP search script for Movable
  Type.</a>
