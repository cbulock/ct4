...
excerpt: >-
  My desktop has reached the two year old mark now.  Though, it's been
  non-operational for the last month.  A while back my DVD burner died, but it
  wasn't the end of the world.  I was backing up a lot of files to it at the
  time and my have over-worked it.  It was, after all, the generic burner Dell
  gives out.  At some point, I ended up subscribing to Netflix and along with
  that started to make copies of all the decent movies I rented.  This was fine
  at first, I have 1.3TB of space on that machine.  Though it may seem like a
  lot of space, once you account for the porn and all those DVD ISO's, it goes
  away quick.
keywords: computer dead hard drive fire video card power supply BTX motherboard
createdOn: '2008-01-28 21:46:06'
modifiedOn: '2011-10-17 15:46:06'
basename: computer_issues
atomId: 'tag:www.cbulock.com,2008://2.566'
weekNumber: '200805'
routeYear: '2008'
routeMonth: '01'
routeKey: 2008/01/computer_issues
canonicalRouteEntryId: '566'
