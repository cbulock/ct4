...
excerpt: >-
  ...
  by one.  Actually, a number of them could be eliminated by writing some code
  that does some code conversion on the web server end. Cause we wouldn't want
  to have an ampersand in a URL without using the correct code for an
  ampersand.  That would just be wrong. :P
keywords: website XHTML validated code
createdOn: '2004-06-07 22:12:05'
modifiedOn: '2011-10-17 15:46:06'
basename: xhtml_valid
atomId: 'tag:www.cbulock.com,2004://2.161'
weekNumber: '200424'
routeYear: '2004'
routeMonth: '06'
routeKey: 2004/06/xhtml_valid
canonicalRouteEntryId: '161'
