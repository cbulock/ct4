...
title: Import all Your E-Mail to GMail
excerpt: >-
  I just located this great free app that will help transfer all of your
  existing e-mail on your PC to your GMail account. If you use a Mozilla based
  e-mail program, you are in luck as it will easily work with this app. It's
  called [GMail Loader](http://www.marklyon.org/gmail/ "Mark Lyon's GMail
  Loader (GML) - Import Your Mail into GMail").  There is a
  number of e-mail formats supported, but the only common one is the mBox format
  used by Mozilla, Netscape and any other good app.  Oddly, I always thought
  Opera used that format for exporting e-mail, but Opera e-mails are in an .MBS
  file, not a .MBX file like mBox.  Good news for Opera users though, there is
  an [MBS-to-MBX](http://www.kmkorn.de/sw/opera/en/mbs2mbx.htm "MBS2MBX - a
  Small Tool for Opera 7") utility.
keywords: gmail email import export mbs2mbx mbox opera outlook filters spam POPFile
createdOn: '2004-07-02 10:04:50'
modifiedOn: '2011-10-17 15:46:06'
basename: import_all_your_email_to_gmail
atomId: 'tag:www.cbulock.com,2004://2.175'
weekNumber: '200427'
routeYear: '2004'
routeMonth: '07'
routeKey: 2004/07/import_all_your_email_to_gmail
canonicalRouteEntryId: '175'
isCanonicalRouteEntry: true
textMoreIgnored: false
---
I just located this great free app that will help transfer all of your existing e-mail on your PC to your GMail account. If you use a Mozilla based e-mail program, you are in luck as it will easily work with this app. It's called [GMail Loader](http://www.marklyon.org/gmail/ "Mark Lyon's GMail Loader (GML) - Import Your Mail into GMail").  There is a number of e-mail formats supported, but the only common one is the mBox format used by Mozilla, Netscape and any other good app.  Oddly, I always thought Opera used that format for exporting e-mail, but Opera e-mails are in an .MBS file, not a .MBX file like mBox.  Good news for Opera users though, there is an [MBS-to-MBX](http://www.kmkorn.de/sw/opera/en/mbs2mbx.htm "MBS2MBX - a Small Tool for Opera 7") utility. 
If you are using Outlook or Outlook Express like many people do, check out [this page](http://zoe.omara.ca/ConvertingToMbox "Converting To Mbox") for some info on how to convert mail formats to mBox.  I have only tried the Opera conversion, so I can't say if converting from other apps works fine, but it's worth a shot.
